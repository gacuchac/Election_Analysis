...
# # Read all the districts and their paths
# districts_to_load = os.path.join("Resources/districts.csv")

# # Initialize district dictionary
# districts = {}

# with open(districts_to_load) as district:
#     file_reader = csv.reader(district)
#     # Read the header row.
#     headers = next(file_reader)
#      # Append each row in the CSV file to the district dictionary.
